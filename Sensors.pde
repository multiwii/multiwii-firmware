...
void ACC_init () {
  ...
  i2c_writeReg(MPU6050_ADDRESS, 0x25, 0x9E);             //I2C_SLV0_ADDR -- I2C_SLV4_RW=1 (read operation) ; I2C_SLV4_ADDR=0x1E (HMC5883 7bit address)
  i2c_writeReg(MPU6050_ADDRESS, 0x26, 0x03);             //I2C_SLV0_REG  -- 6 data bytes of HMC5883 are stored in register whose first address is 0x03
...
//The MAG acquisition function must be replaced because we now talk to the MPU device (done here for HMC5883)
